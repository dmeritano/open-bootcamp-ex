...
import com.dmeritano.spring.config.TokenProvider;
import com.dmeritano.spring.dto.AuthToken;
import com.dmeritano.spring.dto.LoginUser;
...
public class UserController {
    ...
    public AppUser saveUser(@RequestBody UserDto user){
