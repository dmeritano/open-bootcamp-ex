...
@OpenAPIDefinition(
        info = @Info(
                ...
                description = "Amazon Library - Books Rest API",
                contact = @Contact(name = "Administrator", url = "www.amazon.com", email = "info@amazon.com"),
                license = @License(name = "MIT Licence", url = "https://opensource.org/licenses/MIT")),
